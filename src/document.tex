...
\usepackage[
    ...
    pdftitle={Resume - Kenneth E. Bellock},
    pdfsubject={Advanced level high performer.},
    pdfkeywords={Management, Manager, Developer, Development, Python, C++, 6-DOF, Event, Simulation, High Performer},
    pdfproducer={Bellock Ventures},
    pdfcreator={Bellock Resume Toolkit}]{hyperref}
\urlstyle{same}
